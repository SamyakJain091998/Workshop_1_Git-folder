...
//		int i = 1;
//		horizontal 1
		if (boardArray[1] == boardArray[2] && IsEmpty(3))
			return 3;

		if (boardArray[2] == boardArray[3] && IsEmpty(1))
			return 1;
		
		if (boardArray[1] == boardArray[3] && IsEmpty(2))
			return 2;

//		horizontal 2
		if (boardArray[4] == boardArray[5] && IsEmpty(6))
			return 6;

		if (boardArray[5] == boardArray[6] && IsEmpty(4))
			return 4;
		
		if (boardArray[4] == boardArray[6] && IsEmpty(5))
			return 5;

//		horizontal 3
		if (boardArray[7] == boardArray[8] && IsEmpty(9))
			return 9;

		if (boardArray[8] == boardArray[9] && IsEmpty(7))
			return 7;
		
		if (boardArray[7] == boardArray[9] && IsEmpty(8))
			return 8;
		
//		vertical 1
		if (boardArray[1] == boardArray[4] && IsEmpty(7))
			return 7;

		if (boardArray[4] == boardArray[7] && IsEmpty(1))
			return 1;
		
		if (boardArray[7] == boardArray[1] && IsEmpty(4))
			return 4;
		
//		vertical 2
		if (boardArray[2] == boardArray[5] && IsEmpty(8))
			return 8;

		if (boardArray[5] == boardArray[8] && IsEmpty(2))
			return 2;
		
		if (boardArray[2] == boardArray[8] && IsEmpty(5))
			return 5;
		
//		vertical 3
		if (boardArray[3] == boardArray[6] && IsEmpty(9))
			return 9;

		if (boardArray[6] == boardArray[9] && IsEmpty(3))
			return 3;
		
		if (boardArray[3] == boardArray[9] && IsEmpty(6))
			return 6;
		
//		diagonal 1
		if (boardArray[1] == boardArray[5] && IsEmpty(9))
			return 9;

		if (boardArray[5] == boardArray[9] && IsEmpty(1))
			return 1;
		
		if (boardArray[9] == boardArray[1] && IsEmpty(5))
			return 5;
		
//		diagonal 2
		if (boardArray[3] == boardArray[5] && IsEmpty(7))
			return 7;

		if (boardArray[5] == boardArray[7] && IsEmpty(3))
			return 3;
		
		if (boardArray[3] == boardArray[7] && IsEmpty(5))
			return 5;
